        ...
        <Sidebar>
            ...
            <SidebarContent>
                <SidebarMenu>
                    ...
                    <NavItem href="/job-seeker/agent/sub-agents" icon={<Users2 />} currentPath={pathname}>Sub-Agents</NavItem>
                    <NavItem href="/job-seeker/agent/submissions" icon={<BarChart3 />} currentPath={pathname}>Submissions</NavItem>
        ...
        <SidebarInset>
            <header className="flex items-center justify-between p-4 border-b">
                ...
                <div className="flex items-center gap-2">
                    <Button variant="outline">Invite Sub-Agent</Button>
