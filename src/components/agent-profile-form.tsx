  ...
  return (
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        ...
        <CardDescription>Provide these details to verify your identity and business. This helps build trust with recruiters.</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    <FormField control={form.control} name="officeAddress" render={({ field }) => (
                        <FormItem className="md:col-span-2"><FormLabel>Office Address <span className="text-destructive">*</span></FormLabel><FormControl><Textarea rows={3} placeholder="123 Business Bay, Dubai, UAE" {...field} /></FormControl><FormMessage /></FormItem>
                    )} />
                    ...
                    <FormField control={form.control} name="licenseNumber" render={({ field }) => (
                        <FormItem><FormLabel>License / Registration Number <span className="text-destructive">*</span></FormLabel><FormControl><Input placeholder="Enter license number" {...field} /></FormControl><FormDescription>If individual, enter "N/A".</FormDescription><FormMessage /></FormItem>
                    )} />
                    ...
                    <FormField control={form.control} name="gstNumber" render={({ field }) => (
                        <FormItem><FormLabel>GST / VAT Number (if applicable)</FormLabel><FormControl><Input placeholder="Enter GST/VAT number" {...field} /></FormControl><FormMessage /></FormItem>
                    )} />

                     <FormField control={form.control} name="governmentId" render={({ field }) => (
                        <FormItem><FormLabel>Government ID Upload <span className="text-destructive">*</span></FormLabel><FormControl><Input type="file" onChange={(e) => field.onChange(e.target.files)} /></FormControl><FormDescription>Aadhar, Passport, Emirates ID, etc.</FormDescription><FormMessage /></FormItem>
                     )} />
                    
                    {watchAgencyType === 'company' && (
                        <FormField control={form.control} name="businessLicense" render={({ field }) => (
                            <FormItem><FormLabel>Business/Trade License Upload <span className="text-destructive">*</span></FormLabel><FormControl><Input type="file" onChange={(e) => field.onChange(e.target.files)} /></FormControl><FormMessage /></FormItem>
                        )} />
                    )}
                    ...
                    <div className="md:col-span-2">
                        ...
                        <FormMessage>{form.formState.errors.regions?.message}</FormMessage>
                    </div>
                </div>
            </div>
