...
const subAgentProfileSchema = z.object({
  ...
  // Add more fields as needed for the sub-agent's profile
});

export function SubAgentProfileForm() {
  const { updateSubAgentProfile } = useAuth();
  ...
  return (
    <Card className="w-full max-w-2xl mx-auto">
      <CardHeader>
        ...
        <CardDescription>Provide your details to get started as a Sub Agent.</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
